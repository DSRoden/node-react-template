'use strict';
var AxonModel = require('../models/axon.js');
...
exports.deleteOne = function(req, res){
	...
	AxonModel.deleteOne((req.body), function(response){
...
exports.saveOne = function(req, res){
	...
	AxonModel.saveOne((req.body), function(response){
		// console.log('saveOne res in server controller', response);
		res.send(response).end();
	});
};

exports.getOneAxon = function(req, res){
	console.log('req.body in getONe', req.body);
	AxonModel.getOne((req.body), function(response){
		console.log('getOne res in server controller', response);
		res.send(response).end();
	});
};
